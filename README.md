...
* Open RStudio
In the Console window (bottom panel), run the following commands one at a time, pressing Enter after each:
...
Please reach out to `Noelle.Noreen.Kosarek@dartmouth.edu` if you encounter any issues during setup.
